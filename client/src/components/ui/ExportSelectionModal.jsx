...
export default function ExportSelectionModal({ isOpen, onClose, onExport }) {
    ...
    return (
        <div className="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center p-4 z-50 animate-in fade-in duration-200" onClick={onClose}>
            <div className="bg-white w-full max-w-2xl rounded-lg shadow-2xl overflow-hidden" onClick={e => e.stopPropagation()}>
                {/* Header */}
                ...
                <div className="p-6 max-h-[60vh] overflow-y-auto">
                    ...
                    <div className="flex gap-3 mb-6">
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 bg-blue-50 text-blue-600 rounded-lg font-semibold text-sm hover:bg-blue-100 transition-colors border border-blue-100"
                        >
                            <CheckSquare size={16} />
                            Select All
                        </button>
                        <button
                            ...
                            className="flex items-center gap-2 px-4 py-2 bg-gray-50 text-gray-600 rounded-lg font-semibold text-sm hover:bg-gray-100 transition-colors border border-gray-100"
                        >
                            <Square size={16} />
                            Deselect All
                        </button>
                        <div className="ml-auto flex items-center gap-2 px-4 py-2 bg-green-50 text-green-700 rounded-lg text-sm font-bold border border-green-100">
                    ...
                    <div className="space-y-3">
                        {sheets.map(sheet => (
                            <label
                                key={sheet.key}
                                className={`flex items-start gap-4 p-4 rounded-lg border-2 cursor-pointer transition-all ${selectedSheets[sheet.key]
                ...
                <div className="p-6 bg-gray-50 border-t border-gray-100 flex justify-end gap-3">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-6 py-2.5 bg-green-600 text-white rounded-lg font-semibold hover:bg-green-700 transition-all shadow-md disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-green-600"
                    >
                        <Download size={18} />
